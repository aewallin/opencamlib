...
class VD:
    ...
    def setGenerators(self, vd):
        ...
        for p in vd.getGenerators():
            gactor = camvtk.Sphere( center=(p.x,p.y,p.z), radius=2, color=self.generatorColor )
    ...
    def setVertices(self, vd):
        ...
        for p in vd.getVoronoiVertices():
            actor = camvtk.Sphere( center=(p.x,p.y,p.z), radius=2, color=self.vertexColor )
...
if __name__ == "__main__":  
    ...
    myscreen.camera.SetPosition(0.1, 0, 1200)
