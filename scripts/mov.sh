...
# better.
#mencoder mf://frames/ofs/*.png -mf fps=3:type=png  -aspect 16:9 -of lavf -ovc lavc -lavcopts aglobal=1:vglobal=1:coder=0:vcodec=mpeg4:vbitrate=4500 -vf scale=1280:720 -ofps 3000/1001 -o OUTPUT3.mp4
