...
class MillingCutter_py : public MillingCutter, public boost::python::wrapper<MillingCutter> {
  public:
    ...
    bool default_vertexDrop(CLPoint &cl, const Triangle &t) const { return this->MillingCutter::vertexDrop(cl, t); }
    ...
    /// python-wrapper boilerplate...
    bool default_facetDrop(CLPoint &cl, const Triangle &t) const { return this->MillingCutter::facetDrop(cl, t); }
    ...
    /// python-wrapper boilerplate...
    bool default_edgeDrop(CLPoint &cl, const Triangle &t) const { return this->MillingCutter::edgeDrop(cl, t); }
    ...
    /// python-wrapper boilerplate...
    MillingCutter *default_offsetCutter(double d) const { return this->MillingCutter::offsetCutter(d); }
    ...
    /// python-wrapper boilerplate...
    std::string default_str() const { return this->MillingCutter::str(); }
};
