...
void export_cutters() {
    ...
    bp::class_<BullCutter, bp::bases<MillingCutter>>("BullCutter").def(bp::init<double, double, double>());
    bp::class_<ConeCutter, bp::bases<MillingCutter>>("ConeCutter").def(bp::init<double, double, double>());

    bp::class_<CompCylCutter, bp::bases<MillingCutter>>("CompCylCutter").def(bp::init<double, double>());
    bp::class_<CompBallCutter, bp::bases<MillingCutter>>("CompBallCutter").def(bp::init<double, double>());

    bp::class_<CylConeCutter, bp::bases<MillingCutter>>("CylConeCutter").def(bp::init<double, double, double>());
    bp::class_<BallConeCutter, bp::bases<MillingCutter>>("BallConeCutter").def(bp::init<double, double, double>());
