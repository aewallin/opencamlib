...
void Point::matrixRotate(double a, double b, double c, double d, double e, double f, double g, double h, double i) {
...
bool Point::operator==(const Point &p) const { return (this == &p) || (x == p.x && y == p.y && z == p.z); }
