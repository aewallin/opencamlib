...
CLPoint::CLPoint(double x, double y, double z, CCPoint &ccp) : Point(x, y, z) { cc = new CCPoint(ccp); }
...
const CLPoint CLPoint::operator+(const Point &p) const { return CLPoint(this->x + p.x, this->y + p.y, this->z + p.z); }
